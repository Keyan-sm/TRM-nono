...
if __name__ == "__main__":
    ...
    parser.add_argument("--subset", type=str, default="train", help="Subset to build (train/test)")
    args = parser.parse_args()
    
    # Build dataset
    build_dataset(args.input_dir, args.output_dir, args.subset, args.limit)
    
    # Build test if available (assuming same dir structure but different filenames)
    # The script assumes x_train_dataset.npz. 
    # If we want test, we might need to change the call or the script.
    # For now, let's just do train.
